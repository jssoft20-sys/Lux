...
Чат: у каждого клиента один диалог. Закрытое обращение при новом сообщении, «Написать клиенту» или файле в основном боте открывается заново — история остаётся в том же чате, вкладки «Новые»/«Обработанные» показывают одну строку на клиента (старые дубли объединяются миграцией). Три точки в чате — заявки клиента: суммы, статусы, кнопка «Чек» (фото чека), глаз — карточка заявки, нажатие на строку — полная страница; там же «Взять в работу», «Вернуть боту», «Профиль».
...
Пополнения: зачисляется ровно та сумма, что пришла из банка. Если клиент оплатил без тыйынов (900.00 вместо 900.37) и такая заявка одна, она всё равно зачисляется — на 900.00.
