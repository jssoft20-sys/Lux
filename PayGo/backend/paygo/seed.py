...
DEFAULT_CASHES: list[dict[str, Any]] = [
    {
        "key": "1xbet", "name": "1xbet", "provider_type": "servcul", "enabled": True, "priority": 10, "currency": "KGS", "emoji": "😎",
    ...
    {
        "key": "1win", "name": "1win", "provider_type": "xapi", "enabled": True, "priority": 20, "currency": "KGS", "emoji": "🥇",
