"""QR image generation with PayGo branding.
...
BRAND_DARK = (156, 15, 90)  # deep PayGo pink, luminance ~0.08 → contrast 8:1 on white
BRAND_PINK = (232, 24, 122)
LOGO_PATH = PROJECT_ROOT / "frontend" / "admin" / "brand" / "paygo-logo.png"
