#!/usr/bin/env bash
# Восстановление из архива: scripts/restore.sh /home/PayGo/backups/paygo-YYYYmmdd-HHMM.tar.gz
...
echo "restore: done — запустите сервисы: systemctl start paygo-backend paygo-worker paygo-bot paygo-support"
