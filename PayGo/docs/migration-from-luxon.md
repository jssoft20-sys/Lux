# Переход с LUXON (onoi123) на PayGo
...
MacroDroid: замените URL уведомлений на `https://wwweeewww.fit/paygo/api/webhooks/payments/<WEBHOOK_SECRET>` (метод POST, тело — текст уведомления или JSON `{"text": "..."}`).
