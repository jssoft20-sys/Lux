...
function App(){
 ...
 useEffect(function(){L.openPhoto=function(url){setPhoto(url);};L.openLink=function(url){setLinkUrl(url);};return function(){L.openPhoto=null;L.openLink=null;};},[]);
