...
/* ---------- Bank brand ---------- */
var BANKS=[['mbank','#009f8c','M'],['o!','#e4002b','O!'],['odengi','#e4002b','O!'],['денег','#e4002b','O!'],['megapay','#2fca6f','Mg'],['balance','#1e5bf6','B'],['bakai','#0b4f9c','Bk'],['optima','#e2231a','Op'],['demir','#e30613','D'],['elcart','#0a5cab','E'],['kicb','#7a1fa2','K'],['aiyl','#2a7a2a','A'],['dos','#e2001a','DC'],['finca','#00558c','F']];
